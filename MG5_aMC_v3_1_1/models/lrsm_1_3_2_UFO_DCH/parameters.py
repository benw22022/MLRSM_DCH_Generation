...
# vR = Parameter(name = 'vR',
            #    nature = 'internal',
            #    type = 'real',
            #    value = 'cmath.sqrt((2 * MHPPL**2 - alpha3 * (k1**2 - k2**2)) / (rho3 - 2 * rho1))',
            #    texname = 'v_R')

# vR = Parameter(name = 'vR',
            #    nature = 'internal',
            #    type = 'real',
            #    value = 'cmath.sqrt((2*MHPPR**2 - alpha3 * (k1**2 - k2**2)) / (4*rho2))',
            #    texname = 'v_R')

# alpha3 = Parameter(name = 'alpha3',
#                    nature = 'internal',
#                    type = 'real',
#                    value = "2 * (MHPPR**2 - 2 * rho2 * vR**2) / vev**2",
#                    texname = '\\alpha _3')

rho2 = Parameter(name = 'rho2',
                 nature = 'internal',
                 type = 'real',
                 value = "(MHPPR**2 - 0.5 * alpha3 * (k1**2 - k2**2)) / (2 * vR**2)",
                 texname = '\\rho _2')
